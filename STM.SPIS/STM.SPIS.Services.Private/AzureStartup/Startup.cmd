...
if "%Environment%" == "DEV" (
	echo "DEV" >> "C:\Logs\StartupLog.txt" 2>&1
	certutil -enterprise -addstore "Root" "..\staging\AzureStartup\mc-root-cert.cer" >> "C:\Logs\StartupLog.txt" 2>&1
	certutil -enterprise -addstore "Ca" "..\staging\AzureStartup\mc-idreg-cert.cer" >> "C:\Logs\StartupLog.txt" 2>&1
	certutil -enterprise -addstore "Ca" "..\staging\AzureStartup\mc-iala-cert.cer" >> "C:\Logs\StartupLog.txt" 2>&1
	certutil -enterprise -addstore "Ca" "..\staging\AzureStartup\mc-bimco-cert.cer" >> "C:\Logs\StartupLog.txt" 2>&1
	certutil -enterprise -addstore "Root" "..\staging\AzureStartup\SmaStmRootCertificate.cer" >> "C:\Logs\StartupLog.txt" 2>&1
)
