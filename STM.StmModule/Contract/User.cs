...
namespace STM.StmModule.Simulator.Contract
{
    ...
    public partial class User :  IEquatable<User>
    {
        ...
        public User(List<Certificate> Certificates = null, DateTime? CreatedAt = null, string Email = null, string FirstName = null, string LastName = null, string Mrn = null, string Permissions = null, DateTime? UpdatedAt = null)
        {
            ...
            if (Mrn == null)
            {
                throw new InvalidDataException("Mrn is a required property for User and cannot be null");
            }
            else
            {
                this.Mrn = Mrn;
