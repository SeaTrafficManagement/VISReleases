...
namespace STM.StmModule.Simulator.Contract
{
    ...
    public partial class Device :  IEquatable<Device>
    {
        ...
        public Device(List<Certificate> Certificates = null, DateTime? CreatedAt = null, string Mrn = null, string Name = null, string Permissions = null, DateTime? UpdatedAt = null)
        {
            // to ensure "Mrn" is required (not null)
            if (Mrn == null)
            {
                throw new InvalidDataException("Mrn is a required property for Device and cannot be null");
            }
            else
            {
                this.Mrn = Mrn;
